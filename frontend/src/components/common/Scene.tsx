...
export function Scene({ variant = "hero", className, style }: SceneProps) {
  ...
  return (
    <div className={cn("relative overflow-hidden", className)} style={style}>
      ...
      >
        ...
        {/* Sun for dusk */}
        {variant === "dusk" && (
          <circle cx="600" cy="180" r="45" fill="#F0B97A" opacity="0.5" />
        )}

        {/* Distant mountains */}
        <path
          d="M 0 260 L 80 210 L 160 245 L 240 200 L 340 230 L 420 195 L 520 225 L 620 205 L 720 235 L 800 215 L 800 500 L 0 500 Z"
          fill={p.mtn1}
          opacity="0.75"
        />
        ...
        {/* Closer mountains */}
        <path
          d="M 0 320 L 100 265 L 200 300 L 310 255 L 420 290 L 530 260 L 640 295 L 760 275 L 800 290 L 800 500 L 0 500 Z"
          fill={p.mtn2}
          opacity="0.9"
        />

        {/* Fog layer */}
        <rect y="260" width="800" height="140" fill={`url(#${fogId})`} />
        ...
        {variant !== "cabin" && (
          <g transform="translate(360, 350)">
            ...
            {variant === "night" && (
              <circle cx="40" cy="-15" r="20" fill="#F0B97A" opacity="0.3" />
            )}
          </g>
        )}
        ...
        {variant === "cabin" && (
          <g transform="translate(340, 310)">
            ...
            <path
              d="M 90 30 Q 85 10 92 -10 Q 98 -20 90 -40"
              fill="none"
              stroke={p.fog}
              strokeWidth="3"
              opacity="0.5"
