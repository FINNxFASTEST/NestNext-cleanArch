...
import type { IBankAccount } from '../interfaces/bank-account.interface';
import type {
  CampsiteStatus,
  ICampsiteResponse,
} from '../interfaces/campsite.interface';
import type { IPitch, PitchType } from '../interfaces/pitch.interface';

export class PitchResponseDto implements IPitch {
...
export class CampsiteResponseDto implements ICampsiteResponse {
